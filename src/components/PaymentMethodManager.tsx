          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between h-16">
              ...
              <div className="flex space-x-3">
                <button
                  onClick={handleCancel}
                  className="px-4 py-2 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors duration-200 flex items-center space-x-2 text-gray-700"
                >
                  <X className="h-4 w-4" />
                  <span>Cancel</span>
                </button>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent text-gray-900 disabled:bg-gray-100 disabled:text-gray-500"
              ...
              <div>
                ...
                <input
                  type="text"
                  inputMode="numeric"
                  value={formData.account_number.replace(/(\d{4})(\d{3})(\d{4})/, '$1 $2 $3').trim()}
                  onChange={(e) => {
